...
L'estratègia \emph{filter-then-interact} captura efectes principals i interaccions en tres fases progressives, minimitzant overfitting i maximitzant interpretabilitat.
...
\begin{itemize}
    \item \texttt{interactions = 0}
    \item \texttt{learning\_rate = 0.05}
    \item \texttt{max\_bins = 256}
    \item \texttt{max\_rounds = 5000}
...
Els hiperparàmetres utilitzats en aquesta fase són:
\begin{itemize}
    \item \texttt{interactions = 10} (detecció automàtica)
    \item \texttt{learning\_rate = 0.05}
    \item \texttt{max\_bins = 256}
    \item \texttt{max\_rounds = 5000}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/plot_importances.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/fig_014__extract_learned_terms_.png}
